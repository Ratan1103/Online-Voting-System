...
from .views import VoterRegisterView,unverified_voters,verify_voter,PendingVoterListView,VoterVerificationView,VoterStatusView
...
urlpatterns=[
    ...
    path('voter/status/',VoterStatusView.as_view(),name='voter-status'),
